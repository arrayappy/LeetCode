...
<div class="problem-statement">
                <p></p><p><span style="font-size:18px">Given an unsorted array <strong>arr[]</strong> of size <strong>N</strong>, rotate it by <strong>D</strong> elements in the&nbsp;counter-clockwise direction.&nbsp;</span></p>
